...
const OtherProducts = ({ product }: { product: Product | undefined }) => {
  ...
  return (
    <div className="w-full bg-black max-h-[45rem] p-1 py-5 min-h-80 relative rounded-md border-foreground border-2">
          ...
          {data?.products.map((p, idx) => (
            ...
            >
              <div className="min-w-24 h-24 relative rounded border-foreground border-2">
                <Image src={p.images[0].url} alt={"image product"} fill />
              </div>
